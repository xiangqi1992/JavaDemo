...
public class EmpTest {
     ...
     */
    @Test
    public void testMore2OneMapper() throws IOException {
        EmpMapper mapper = getMapper(EmpMapper.class);

        // a> 级联方式处理映射关系
        Emp result = mapper.getEmpAndDeptByEid(1);

        // b> 使用association处理映射关系
        // Emp result = mapper.getEmpAndDeptByEid2(1);

        // c> 分步查询
        // Emp result = mapper.getEmpByStep(1);
